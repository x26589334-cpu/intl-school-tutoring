...
- **이미 사용한 사진/번호 (중복 금지):**
  ...
  - 다음 글은 news-52부터. ⚠️ 사용자 선호: **글자 썸네일 별로임 → 실제 사진 사용할 것.** 집 PC엔 '국제학교 사진' 폴더가 없으므로, 폴더 있는 사무실 PC에서 작업하거나(폴더의 미사용 미국 학교 사진 사용), 집 PC에선 repo 기존 실제 캠퍼스 사진(news7~14 등 간판 없는 캠퍼스 컷)을 재사용. 글자 썸네일은 최후수단.
