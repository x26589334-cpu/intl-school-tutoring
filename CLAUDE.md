...
- **이미 사용한 사진/번호 (중복 금지):**
  ...
  - 다음 글은 news-176부터. 📝 **미사용 주제 후보**: 국제학교 여름캠프/서머스쿨, IGCSE 과목선택, 조기유학 적정 시기, 국제학교 학비 비교, A-Level 과목선택 / 미사용 EJU 지역(목동·평촌·창원·전주·천안) / **해외 학교 개별글 후보(지역글에 이름만 있는 학교)**: UWCSEA·탕린(싱가포르), CDNIS·ESF(홍콩), ASIJ·니시마치·YIS(도쿄), JIS·BSJ(자카르타), DAA·GEMS(두바이), ISB·하로우(방콕), Concordia·YCIS(상하이) / **국내 미사용**: 서울일본인학교, 부산일본인학교, 재한몽골학교.
