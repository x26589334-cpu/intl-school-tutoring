...
- **이미 사용한 사진/번호 (중복 금지):**
  ...
  - news116=덜위치칼리지 서울(서초·영국계 IGCSE·A-Level), news117=브랭섬홀아시아 BHA(제주·IB 여학교·내국인가능) (7/29, 학교 개별글 2편 + 후기 5개). 사진 news13·8·60·14 재사용.
  - 다음 글은 news-118부터. 📝 **미사용 조합**: APIS·청라달튼·KIS제주·SJA(세인트존스베리)·광주외국인학교(GIS)·거제/경남 IFS / 목동·평촌·창원·전주·천안 EJU / 국가 country 페이지(태국·일본·호주·필리핀·스위스·뉴질랜드·인도네시아·인도).
